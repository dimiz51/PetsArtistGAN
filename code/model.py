    ...
    def train_step(self, batch_input):
        ...
        with tf.GradientTape(persistent=True) as tape:
            ...
            cycle_loss = self.cycle_loss_fn(
                real_x, reconstructed_x
            ) + self.cycle_loss_fn(real_y, reconstructed_y)
        ...
        self.disc_X_optimizer.apply_gradients(
            zip(disc_X_gradients, self.discriminator_X.trainable_variables)
        )
        ...
        self.disc_Y_optimizer.apply_gradients(
            zip(disc_Y_gradients, self.discriminator_Y.trainable_variables)
        )
